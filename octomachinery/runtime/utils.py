...
class _ContextMap:
    ...
    def __init__(self, **initial_vars: str) -> None:
    ...
    # NOTE: The return type has to stay `typing.Any` — it is the escape
    # NOTE: hatch that makes the `RUNTIME_CONTEXT.<var>.<attr>` chains
    # NOTE: in the downstream code type-check at all.
